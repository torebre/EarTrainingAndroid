...
public class SequenceToSvgTest {
    ...
    public static void generateSequence() throws IOException, ParserConfigurationException, TransformerException {
...
// Set the width and height attributes on the root 'svg' element.
        ...
        SVGRect svgRect = svgDocument.getRootElement().createSVGRect();
