...
import com.kjipo.representation.ClefType;
import com.kjipo.representation.ElementType;
import com.kjipo.representation.Event;
import com.kjipo.representation.EventSeries;
import com.kjipo.representation.EventSeriesFactoryProvider;
...
public class SequenceTransformationTest {
    ...
    public void encodeSequenceTest() throws IOException {
        ...
        byte midiData[] = com.kjipo.midi.MidiUtilities.transformSequenceToMidiFormat(sequence);
